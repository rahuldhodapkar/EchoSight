...
class VisionObjectRecognitionViewController: ViewController {
    ...
    var midiPlayer: MIDIInstrumentPlayer!
    var midiPlaying: Int = 0
    ...
    func setupVision() -> NSError? {
        ...
        // set up MIDI Instrument Player
        midiPlayer = MIDIInstrumentPlayer()
    ...
    func stringToUInt8Sum(_ string: String, max: UInt8) -> UInt8 {
        guard max > 0 else { return 0 }
        
        let sum = string.unicodeScalars.reduce(0) { $0 + UInt32($1.value) }
        
        // Scale the sum to fit within 0...max range
        let boundedValue = UInt8(sum % UInt32(max + 1))
        return boundedValue
    }
